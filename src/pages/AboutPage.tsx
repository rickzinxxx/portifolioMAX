  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 py-20 flex flex-col gap-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        {/* Left Side: Avatar frame placeholder (Rickzinxx visual brand) */}
        <div className="md:col-span-4 flex justify-center">
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="relative w-48 h-48 md:w-64 md:h-64 rounded-full p-1 bg-gradient-to-tr from-primary to-orange-500 shadow-[0_0_50px_rgba(255,40,0,0.3)] group overflow-hidden"
          >
            <div className="w-full h-full rounded-full bg-black/90 flex flex-col items-center justify-center p-4 relative overflow-hidden text-center">
              <Code2 className="w-16 h-16 text-primary group-hover:scale-110 transition-transform duration-500 mb-2" />
              <span className="font-mono text-[10px] uppercase tracking-widest text-zinc-500">Rickzinxx</span>
              <span className="font-sans font-black text-xs uppercase text-white mt-1">Frontend Dev</span>
