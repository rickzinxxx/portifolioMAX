...
import { Code2, ChevronRight, Palette, Laptop, Sparkles, Cpu, Layers, GitBranch, Terminal, Camera, User } from "lucide-react";
    ...
    <div className="w-full max-w-4xl mx-auto px-6 py-20 flex flex-col gap-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        ...
        <div className="md:col-span-4 flex justify-center">
          ...
          >
            <div className="w-full h-full rounded-full bg-black/90 flex flex-col items-center justify-center relative overflow-hidden text-center animate-avatar-box">
              {avatarUrl ? (
                <img 
                  src={avatarUrl} 
                  alt="Rickzinxx" 
                ...
                <div className="w-full h-full flex flex-col items-center justify-center rounded-full bg-zinc-950 border border-white/5 relative">
                  ...
                  <User className="w-16 h-16 text-zinc-500 group-hover:text-primary transition-colors duration-300 relative z-10" />
                  <span className="font-mono text-[9px] uppercase tracking-widest text-zinc-600 group-hover:text-primary/70 transition-colors duration-300 relative z-10 mt-1">Rickzinxx</span>
                </div>
              )}
