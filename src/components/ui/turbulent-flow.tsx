...
export const TurbulentFlow = ({ children }: TurbulentFlowProps) => {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      if (materialRef.current) {
        materialRef.current.uniforms.u_turbulence.value += mouseInfluence * 0.1;
      }
    };
    ...
    const animate = () => {
      ...
      if (materialRef.current) {
        ...
        materialRef.current.uniforms.u_sharpness.value += breathe;
      }
