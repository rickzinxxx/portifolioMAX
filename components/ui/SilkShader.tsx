...
/**
 * SilkShader component provided by the user (demo.tsx).
 * Renders a WebGL interactive silk-like shader.
 */
export default function SilkShader({ className }: SilkShaderProps = {}) {
  ...
  useEffect(() => {
    ...
    const resetMouseZ = () => { mouse.z = 0; };

    canvas.addEventListener('mousemove', onMouseMove);
    canvas.addEventListener('mousedown', onMouseDown);
    canvas.addEventListener('mouseup', resetMouseZ);
    canvas.addEventListener('mouseleave', resetMouseZ);
    ...
    return () => {
      ...
      canvas.removeEventListener('mouseup', resetMouseZ);
      canvas.removeEventListener('mouseleave', resetMouseZ);
    };
  }, [isDark]);
